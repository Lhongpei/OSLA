# -*- coding: utf-8 -*-
"""
OS-GDN (OSGM + GatedDeltaNet) config.

Fork of `fla.models.gated_deltanet` that adds OSGM configuration fields,
following the same pattern used by `fla.models.os_delta_net` on top of
...
class OSGDNConfig(PretrainedConfig):
    model_type = 'os_gated_deltanet'
