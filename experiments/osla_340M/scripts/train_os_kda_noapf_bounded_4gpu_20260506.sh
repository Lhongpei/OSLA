#!/bin/bash
# OS-KDA 340M bounded no-APF candidate on 4xH100.
...
export WANDB_NAME="${WANDB_NAME:-os-kda-340M-noapf-eta0p003-dmin0p667-dmax1p5-4gpu-full-20260506}"
...
DUMP="${DUMP:-$ROOT/experiments/osla_340M/exp/os-kda-340M-noapf-eta0p003-dmin0p667-dmax1p5-4gpu-full-20260506}"
CONFIG="${CONFIG:-$ROOT/experiments/osla_340M/configs/os-kda-340M-noapf-eta0p003-dmin0p667-dmax1p5-ba1.json}"
TOKENIZER="${TOKENIZER:-fla-hub/delta_net-1.3B-100B}"
RDZV_ENDPOINT="${RDZV_ENDPOINT:-localhost:29517}"
