#!/bin/bash
# OSLA-OSGM 340M chunk mode - run2 (7xH100, skip GPU3)
...
export WANDB_NAME=deltanet-340M-osla-osgm-chunk-run2
export CUDA_VISIBLE_DEVICES=0,1,2,4,5,6,7

DUMP=/home/datagen/OSLA/experiments/osla_340M/exp/deltanet-340M-osla-osgm-chunk-run2
...
echo "OSLA-OSGM chunk training (run2) finished!"
