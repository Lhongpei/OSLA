#!/bin/bash
# OSLA 340M v2 — uses fixed kernel (fla/ops/osla_delta_rule) on 8xH100
...
export WANDB_NAME=deltanet-340M-osla-v2

DUMP=/home/datagen/OSLA/experiments/osla_vs_deltanet_340M_v2/exp/deltanet-340M-osla-v2
CONFIG=/home/datagen/OSLA/experiments/osla_vs_deltanet_340M_v2/configs/delta_net_340M_osla_v2.json
...
echo "OSLA v2 training finished!"
