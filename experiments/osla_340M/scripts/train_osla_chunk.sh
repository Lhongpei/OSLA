#!/bin/bash
# OSLA 340M chunk mode — with learnable initial preconditioner on 8xH100
...
export WANDB_NAME=deltanet-340M-osla-chunk

DUMP=/home/datagen/OSLA/experiments/osla_340M/exp/deltanet-340M-osla-chunk
CONFIG=/home/datagen/OSLA/experiments/osla_340M/configs/osla_chunk.json
...
echo "OSLA chunk training finished!"
