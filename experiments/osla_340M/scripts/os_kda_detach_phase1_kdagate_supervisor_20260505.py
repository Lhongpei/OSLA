...
RUN_ROOT = EXP_DIR / f'os-kda-detach-phase1-kdagate-supervisor-{STAMP}'
...
CANDIDATES = [
    ...
    {'eta': 0.003, 'd_max': 1.2, 'beta_aware': True},
    {'eta': 0.003, 'd_max': 1.05, 'beta_aware': True},
]
...
def tag_for(kind, cand):
    ...
    return f'os-kda-340M-detach-phase1-kdagate-{decay}-eta{fmt_float(cand["eta"])}-dmax{fmt_float(cand["d_max"])}-{ba}'
