...
RUN_ROOT = EXP_DIR / f'os-kda-stability-supervisor-{STAMP}'
...
CANDIDATES = [
    {'eta': 0.10, 'd_max': 1e9, 'beta_aware': True},
    {'eta': 0.03, 'd_max': 1e9, 'beta_aware': True},
    {'eta': 0.01, 'd_max': 1e9, 'beta_aware': True},
    {'eta': 0.03, 'd_max': 100.0, 'beta_aware': True},
    {'eta': 0.01, 'd_max': 100.0, 'beta_aware': True},
    # Last-resort diagnostic if beta-aware remains unstable.
    {'eta': 0.10, 'd_max': 1e9, 'beta_aware': False},
    {'eta': 0.03, 'd_max': 1e9, 'beta_aware': False},
]
...
def tag_for(kind, cand):
    ...
    return f'os-kda-340M-{decay}-eta{fmt_float(cand["eta"])}-dmax{fmt_float(cand["d_max"])}-{ba}'
