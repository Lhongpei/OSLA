#!/bin/bash
# OSLA-OSGM 340M chunk mode with learnable initial_d (8xH100)
...
export WANDB_NAME=deltanet-340M-osla-osgm-chunk-learnable-d0
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7

DUMP=/home/datagen/OSLA/experiments/osla_340M/exp/deltanet-340M-osla-osgm-chunk-learnable-d0
CONFIG=/home/datagen/OSLA/experiments/osla_340M/configs/osla_osgm_chunk.json
...
echo "OSLA-OSGM chunk training (learnable d0) finished!"
