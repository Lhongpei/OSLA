#!/bin/bash
# EMA variant (normalized): d_i = [1/EMA(k_i^2)] / <1/EMA(k^2), k^2>
# Maintains <d,k²>=1 by construction; isolates pure fixed-point difference from OSGM
#
...
export WANDB_NAME=deltanet-340M-osla-osgm-ema-norm

DUMP=/home/datagen/OSLA/experiments/osla_340M/exp/deltanet-340M-osla-osgm-ema-norm
CONFIG=/home/datagen/OSLA/experiments/osla_340M/configs/osla_osgm_ema_norm.json
...
echo "EMA (normalized) training finished!"
