#!/bin/bash
# OSLA-OSGM 340M chunk mode on 8xH100
...
export WANDB_NAME=deltanet-340M-osla-osgm-chunk

DUMP=/home/datagen/OSLA/experiments/osla_340M/exp/deltanet-340M-osla-osgm-chunk
...
echo "OSLA-OSGM chunk training finished!"
